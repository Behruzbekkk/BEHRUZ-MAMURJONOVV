...
fetch("https://jsonplaceholder.typicode.com/users")
  ...
  .then((objectData) => {
    ...
    <td><a href= "tel:${values.phone}"><i class="bi bi-telephone"></i></a><a href="email:${values.email}"><i class="bi bi-envelope leftIcon"></i></a></td>
    ...
    saveModal.addEventListener("click", function () {
      ...
      saveModalTable = `
        <tr class="trTableData">
        <td><input type="checkbox"></td>
        <td class="imgTd"><div class="imgTable"></div><p>${inputM1.value}</p></td>
